...
<body>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">SUPPLIER</span></h2>
        <a class="btn btn-primary mb-4 mx-xl-5" href="add_supplier.php">Add New Supplier</a>
        <div class="row px-xl-5">
                ...
                <div class="product-item bg-light mb-4 h-100">
                    <div class="text-center py-4">
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $supplier['kode_supplier'] ?></h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $supplier['nama_supplier'] ?></h5>
                        </div>
                    </div>
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/<?php echo $supplier['logo_supplier'] ?>" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark" href="edit_supplier.php?id=<?php echo $supplier["kode_supplier"]?>">EDIT</a>
                            <a class="btn btn-outline-dark" href="backend/proses_delete_supplier.php?id=<?php echo $supplier["kode_supplier"]?>" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
                        </div>
                    </div>
                    <div class="text-center py-4">
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $supplier['email_supplier'] ?></h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6><?php echo $supplier['telp_supplier'] ?></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $supplier['alamat_supplier'] ?></h5>
                        </div>
                    </div>
                </div>
            </div>
