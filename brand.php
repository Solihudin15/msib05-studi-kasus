<?php
    ...
    $brands = mysqli_query($connection, "SELECT * FROM brand");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="brand.php" class="nav-item nav-link active">Brand</a>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <a class="btn btn-primary mb-4 mx-xl-5" href="add_brand.php">Add New Brand</a>
        <div class="row px-xl-5">
            <?php
            foreach ($brands as $brand){
            ?>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1 mb-4">
                <div class="product-item bg-light mb-3 h-100" >
                    <div class="text-center py-4">
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $brand['kode_brand'] ?></h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6><?php echo $brand['nama_brand'] ?></h6>
                        </div>
                    </div>
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="img/<?php echo $brand['logo_brand'] ?>" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark" href="edit_brand.php?id=<?php echo $brand["kode_brand"]?>">EDIT</a>
                            <a class="btn btn-outline-dark" href="backend/proses_delete_brand.php?id=<?php echo $brand["kode_brand"]?>" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
                        </div>
                    </div>
                    <div class="text-center py-4">
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <h5><?php echo $brand['website'] ?></h5>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo $brand['asal_brand'] ?></h5>
                        </div>
                    </div>
                </div>
            </div>
