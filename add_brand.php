    ...
    <div class="container-fluid pt-5 pb-3">
        <div class="row px-xl-5">
            ...
            <div class="col-md-6">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="backend/proses_add_brand.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Kode Brand</label>
                            <input type="text" class="form-control" name="kode_brand">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="asal_brand">
                        </div>
                        <div class="form-group">
                            <label>Website</label>
