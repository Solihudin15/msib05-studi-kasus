...
<?php
    ...
    $brands = mysqli_query($connection, "SELECT * FROM brand WHERE kode_brand = '$id' ");
    
    foreach ($brands as $brand){
        $nama_brand = $brand['nama_brand'];
        $asal_brand = $brand['asal_brand'];
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary rounded border-primary">
                    <div class="card-header bg-primary">
                        <h3 class="card-title mb-0">EDIT DATA BRAND</h3>
                    </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="backend/proses_edit_brand.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Kode Brand</label>
                            <input type="text" class="form-control" name="kode_brand" value="<?php echo $id; ?>" disabled>
                        </div>
                        <div class="form-group">
                            <label>Nama Brand</label>
                            <input type="text" class="form-control" name="nama_brand" value="<?php echo $nama_brand; ?>">
                        </div>
                        <div class="form-group">
                            <label>Asal Brand</label>
                            <input type="text" class="form-control" name="asal_brand" value="<?php echo $asal_brand;?>">
                        </div>
                        <div class="form-group">
                            <label>Website</label>
                        ...
                        <div class="form-group">
                            <label>Logo</label>
                            <input class="form-control" type="file" name="logo_brand">
                        </div>
                    </div>
                    <!-- /.card-body -->
