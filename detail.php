...
<?php
    ...
    $products = mysqli_query($connection, "SELECT * FROM produk JOIN brand ON produk.kode_brand = brand.kode_brand JOIN supplier ON produk.kode_supplier = supplier.kode_supplier WHERE id_produk = '$id' ");
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/<?php echo $product['picture'] ?>" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">Rp <?php echo number_format($price) ?></h3>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Brand:</strong>
                        <strong class="text-dark mr-3 mx-3"><?php echo $nama_brand ?></strong>
                    </div>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Supplier:</strong>
                        <strong class="text-dark mr-3"><?php echo $nama_supplier ?></strong>
                    </div>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Storage:</strong>
                        <select class="form-control w-25" name="storage">
                    ...
                    <div class="d-flex mb-4">
                        ...
                        <select class="form-control w-25 mx-4" name="ram">
