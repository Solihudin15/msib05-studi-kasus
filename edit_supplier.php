...
<?php
    ...
    $suppliers = mysqli_query($connection, "SELECT * FROM supplier WHERE kode_supplier = '$id' ");
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary rounded border-primary">
                    <div class="card-header bg-primary">
                        <h3 class="card-title mb-0">EDIT DATA SUPPLIER</h3>
                    </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="backend/proses_edit_supplier.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Kode Supplier</label>
                            <input type="text" class="form-control" name="kode_supplier" value="<?php echo $id; ?>" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="telp_supplier" value="<?php echo $telp_supplier; ?>">
                        </div>
                        <div class="form-group">
                            <label>Email Supplier</label>
                            <input type="text" class="form-control" name="email_supplier" value="<?php echo $email_supplier; ?>">
                        </div>
                        <div class="form-group">
                            <label>Alamat Supplier</label>
                            <input type="text" class="form-control" name="alamat_supplier" value="<?php echo $alamat_supplier; ?>">
                        </div>
                        <div class="form-group">
                            <label>Logo</label>
