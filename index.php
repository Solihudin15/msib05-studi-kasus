<?php
    ...
    $products = mysqli_query($connection, "SELECT * FROM produk ORDER BY id_produk DESC LIMIT 8");
?>
    ...
    <div class="container-fluid">
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            ...
            <div class="col-lg-4 col-6 text-left">
                <form form action="shop.php" method="post">
        ...
        <div class="row px-xl-5">
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">GAMING PHONE</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Play the game, and experience a different kind of victory</p>
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Infinix ZERO 5G 2023</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Fastest 5G Smartphone in-segment</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="shop.php">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">A17 Pro chip. A monster win for gaming</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="shop.php">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Infinix Hot 11S</h6>
        ...
        <div class="row px-xl-5">
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">POCO X3 NFC</h6>
                        <h3 class="text-white mb-3">Rp 3.099.000</h3>
                        <a href="shop.php" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Samsung Galaxy M31</h6>
                        <h3 class="text-white mb-3">Rp 3.499.000</h3>
                        <a href="shop.php" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
            </div>
